    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                    ...
                    <td><input type="number" id="route_1" value="08" style="width:60px;" oninput="if(this.value.length>2)this.value=this.value.slice(0,2);"></td>
                </tr>
                <tr>
                    <td>Дорожка 2</td>
                    <td class="status-cell st-0" id="node_st_2">0</td>
                    <td><input type="number" id="route_2" value="12" style="width:60px;" oninput="if(this.value.length>2)this.value=this.value.slice(0,2);"></td>
                </tr>
                <tr>
                    <td>Дорожка 3</td>
                    <td class="status-cell st-0" id="node_st_3">0</td>
                    <td><input type="number" id="route_3" value="15" style="width:60px;" oninput="if(this.value.length>2)this.value=this.value.slice(0,2);"></td>
                </tr>
                <tr>
                    <td>Дорожка 4</td>
                    <td class="status-cell st-0" id="node_st_4">0</td>
                    <td><input type="number" id="route_4" value="02" style="width:60px;" oninput="if(this.value.length>2)this.value=this.value.slice(0,2);"></td>
                </tr>
                <tr>
                    <td>Дорожка 5</td>
                    <td class="status-cell st-0" id="node_st_5">0</td>
                    <td><input type="number" id="route_5" value="09" style="width:60px;" oninput="if(this.value.length>2)this.value=this.value.slice(0,2);"></td>
                </tr>
                ...
                <tr style="background: #1a2925;">
                    ...
                    <td>
                        <div class="manual-inputs">
                            <span>Откуда:</span>
<input type="number" id="man_from" value="03" style="width: 50px;" oninput="if(this.value.length > 2) this.value = this.value.slice(0,2);">
<span>Куда:</span>
<input type="number" id="man_to" value="15" style="width: 50px;" oninput="if(this.value.length > 2) this.value = this.value.slice(0,2);">
            ...
            .then(data => {
                ...
                if (data.manual_active === 1) {
                    ...
                    row.innerHTML = `
                        ...
                        <div class="task-status">'В ПУТИ'</div>
                    `;
